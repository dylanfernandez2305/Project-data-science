...
Test set results (top 5 models shown, 56,746 transactions, 98 frauds, validation-optimized thresholds):
...
- **[2]** Train & Save Models - Train all 9 models and save them (15-30 min) - no need if already saved
...
- All 9 models (8 individual + ensemble)
- Training timestamp
...
**Normal:** 15-30 minutes for all 9 models
